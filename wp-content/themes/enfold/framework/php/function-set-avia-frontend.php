...
if(!function_exists('kriesi_backlink'))
{
	...
	{	
		...
		if($random_number % 3 == 0) $theme_string = "Desarrollado por Crescendo Pixel";
		if($random_number % 3 == 1) $theme_string = THEMENAME." WordPress Theme by Crescendo Pixel";
		...
		$link = " - <a {$no} href='http://crescendopixel.com' target='_blank'>{$theme_string}</a>";
